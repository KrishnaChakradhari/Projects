...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="#">Doner Login</a>
      </div>
  ...
  <div class="container">
    ...
    <a href="doner_register.php"> Create Account</a>
  ...
  <?php
    if(isset($_POST['email'])==true)
    {
        ...
        $q="select * from doner where email='$email' and password='$password'";
    ...
    if($row=mysqli_fetch_array($rs))
{
    ...
    echo 
    "<script>
    window.location='doner_dashbord.php'
    </script>";
}
else
{
