...
while($row=mysqli_fetch_array($rs))
{
  echo"
    ...
    <input type='text' name='blood_group' value='$row[blood_group]'> <br>

    <label for='fname'>Units</label> <br>
    <input type='text' name='units' value='$row[units]'><br>

    <label for='fname'>Disease</label> <br>
    <input type='text' name='disease' value='$row[disease]'> <br>
