...
<body>
    ...
    <div class="mb-3" style="width: 80%; margin-left: 10%;">
        <div class="section-title mb-0">
            <h4 class="m-0 text-uppercase font-weight-bold">Manage Admins</h4>
        </div>
        <div class="bg-white border border-top-0 p-4">
            ...
            $q = "select * from admin_registration";
            ...
            <div class='cards-container21'>
                <div class='card21'>
                    <div class='card-header21'>
                        <img src='images/$row[photo]' alt='news-image' id='news-img'>
                    </div>

                    <div class='card-content21'>
                        <h3 id='news-title'>$row[full_name]</h3>

                        <a class='badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2' style='font-size:14px;'
                                                    href=''>$row[mobile]
                        </a>

                        <h6 class='news-source' id='news-source'>Email : $row[email]</h6>
                        <p class='news-desc' id='news-desc'></p>
                    </div>
                    <div class='card-buttons21'>
                        
                    <a class='edit-button' style='padding: 6px 12px;' href='admin_full_details.php?id=$row[id]&full_name=$row[full_name]'>
                        Full Details
                    </a>

                    <a class='delete-button' style='padding: 6px 12px;' href='delete_admin.php?id=$row[id]'>
                        Delete
                    </a>
                    </div>
                </div>
        ...
        <a class='badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2'
                    style='width: 100%; height:35px; font-size: 18px; margin-top: 5px;' href='admin_registration.php'>
                    Add New Admin
                </a>
        </div>
    </div>
