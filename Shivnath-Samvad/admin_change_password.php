...
<body>
    ...
    <div class="mb-3" style="width: 40%; margin-left: 30%; padding-top:3%">
        <div class="section-title mb-0">
            <h4 class="m-0 text-uppercase font-weight-bold"> Admin Change Password</h4>
        </div>
...
if (isset($_POST['old_password']) == true) {

    $new_password = $_POST['new_password'];

    $con = mysqli_connect("localhost", "root", "root", "news", "3308");
    $q = "update admin_registration set password='$new_password' where id='$id'";
    ...
    if ($rs) {
        ...
        <div class='form-group mb-0'>
                    <center>
                        <a href=admin_login.php class='btn btn-primary font-weight-semi-bold py-2 px-3'>Login</a>
                    </center>
                </div>
