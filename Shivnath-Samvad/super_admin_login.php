...
<body>
    ...
    <div class="mb-3" style="width: 40%; margin-left: 30%; padding-top:3%">
        <div class="section-title mb-0">
            <h4 class="m-0 text-uppercase font-weight-bold">Super Admin Login</h4>
        </div>
...
if (isset($_POST['id']) == true) {
    ...
    $q = "select * from super_admin_login where id='$id' and password='$password'";
    ...
    if ($row = mysqli_fetch_array($rs)) {
        ...
        echo
            "<script>
                    window.location='super_admin_dashbord.php'
            </script>";
    } else {
        echo "<br><br>
